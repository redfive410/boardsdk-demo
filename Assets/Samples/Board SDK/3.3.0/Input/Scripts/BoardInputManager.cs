            ...
            for (var i = 0; i < contacts.Length; i++)
            {
                ...
                switch (contact.phase)
                {
                    case BoardContactPhase.Began:
                        ...
                        Debug.Log($"[Board] {contact.type} PLACED — id:{contact.contactId} glyphId:{contact.glyphId} pos:{position}");
                    ...
                    case BoardContactPhase.Moved:
                        Debug.Log($"[Board] {contact.type} MOVED — id:{contact.contactId} glyphId:{contact.glyphId} pos:{position} rot:{contact.orientation * Mathf.Rad2Deg:F1}° isTouched:{contact.isTouched}");
                    ...
                    case BoardContactPhase.Ended:
                        Debug.Log($"[Board] {contact.type} LIFTED — id:{contact.contactId} glyphId:{contact.glyphId}");
